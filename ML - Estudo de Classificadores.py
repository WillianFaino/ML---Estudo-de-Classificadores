...
# print(dados.groupby('Class').size())
...
knn.fit(trainingAttSet, trainingClassSet) 
knnPredict = knn.predict(testingAttSet)
KNNTV = knn.predict_proba(testingAttSet)    
...
dt = DecisionTreeClassifier()   
dt.fit(trainingAttSet, trainingClassSet) 
dtPredict = dt.predict(testingAttSet)
DTTV = dt.predict_proba(testingAttSet)    
...
nb = GaussianNB()   
nb.fit(trainingAttSet, trainingClassSet) 
nbPredict = nb.predict(testingAttSet)
NBTV = nb.predict_proba(testingAttSet)    
...
svm.fit(trainingAttSet, trainingClassSet) 
svmPredict = svm.predict(testingAttSet)
SVMTV = svm.predict_proba(testingAttSet)    
